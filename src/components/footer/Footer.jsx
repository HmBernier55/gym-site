  ...
  return (
    <div className='bg-slate-950 py-20 px-40 flex items-center justify-between flex-col lg:flex-row gap-5'>
      ...
      <div className='text-white font-medium gap-6 grid lg:grid-cols-5 text-center'>
        ...
        <Link to='/amenities' className='hover:text-lime-500'>
          AMENITIES
        </Link>
      ...
      <div className='flex items-center justify-center space-x-6'>
        <Link to='#' className='p-1.5 rounded-full hover:bg-blue-600'>
        <svg
        ...
        <Link to='#' className='p-1.5 rounded-full hover:bg-blue-400'>
        <svg
          className="w-6 h-6 text-white"
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
        ...
        <Link to='#' className='p-1.5 rounded-full hover:bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045]'>
        <svg
          className='w-6 h-6 text-white'
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
